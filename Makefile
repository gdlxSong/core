...
API_PROTO_FILES := api/core/v1/entity.proto api/core/v1/subscription.proto api/core/v1/list.proto api/core/v1/search.proto api/core/v1/ts.proto api/core/v1/topic.proto api/core/v1/event.proto api/core/v1/schema.proto
